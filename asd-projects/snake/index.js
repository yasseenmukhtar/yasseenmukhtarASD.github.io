...
function handleAppleCollision() {
  ...
  */
  ...
  // Check the direction of the tail to determine the correct position of the new segment
  if (snake.tail.direction === "left") {
    column += 1; // Place the new segment to the right of the tail
  } else if (snake.tail.direction === "right") {
    column -= 1; // Place the new segment to the left of the tail
  } else if (snake.tail.direction === "up") {
    row += 1; // Place the new segment below the tail
  } else if (snake.tail.direction === "down") {
    row -= 1; // Place the new segment above the tail
  }

  // Add the new segment to the snake at the calculated row and column
